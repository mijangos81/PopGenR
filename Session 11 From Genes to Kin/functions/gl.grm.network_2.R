...
#' @param method_relatedness Method to calculate relatedness [default "grm"].
...
gl.grm.network_2 <- function(G,
                           x,
                           method_relatedness = "grm",
                           method = "fr",
                           node.size = 8,
                           node.label = TRUE,
                           node.label.size = 2,
  ...
  if(method_relatedness!="grm"){
    ...
    # links_tmp[links_tmp$kinship<0,"kinship"] <- 0
    # links[links$weight<=0,"weight"] <- 0
    links_tmp <- links
  }
