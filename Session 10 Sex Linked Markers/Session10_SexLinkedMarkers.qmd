...
res$sex.biased
res$autosomal
res$results.table  # The output table
```
...
Can you find individuals for which the `agreed sex` is uncertain?
...
![](images/beer.png){.class width="350" height="200"}

![](images/Eastern_Yellow_Robin.jpg){alt="The Eastern Yellow Robin" width="349"}
...
EYR$other$ind.metrics[EYR$other$ind.metrics$sex != sexID$agreed.sex,]
```
