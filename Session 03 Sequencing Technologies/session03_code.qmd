...
We now see that our heterozygosity is found to be highest in the Kimberley and lowest in Central Australia, which is true.v
...
In a full analysis of all the data, with unequal sample numbers and SNPs called on all populations, we got a result that the Kimberley population was the least diverse.
This would then result in a direction that the most genetically important population is actually one of the least.
:::
